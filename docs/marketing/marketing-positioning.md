...
### From real agent usage (Nexus project, 2026-04-28)
...
2. **"From 5 Steps to 1: How an AI Agent Learned to Trust TracePulse"** - Real story from Nexus. Agent went from manual verification to habitual `get_build_errors`.
...
5. **Real agent feedback loop** - We're iterating based on actual agent behavior (Nexus), not hypothetical use cases.

...
1. Read `docs/audits/security/SECURITY_LOG.md` to understand what has been reviewed before
2. Read `docs/roadmap/roadmap.md` to identify specs completed since the last SRR
3. Identify the next SRR number by checking `docs/audits/security/` for existing reports
...
6. Create `docs/audits/security/SRR-{###}-{YYYY-MM-DD}-T2.md` with the full report
7. Update `docs/audits/security/SECURITY_LOG.md` with new findings
...
5. For each finding:
   ...
   - Propose 2-3 remediation pathways with pros/cons
   - Recommend the best option with justification
6. Create `docs/audits/security/SRR-{###}-{YYYY-MM-DD}-T3.md` with the full report
7. Update `docs/audits/security/SECURITY_LOG.md` with new findings
8. For CRITICAL/HIGH findings: create immediate fix tasks
9. For MEDIUM/LOW findings: add to roadmap as future items
10. Update `docs/roadmap/roadmap.md` security reviews table
11. Record dependency manifest snapshot in `docs/audits/security/dep-snapshot-{YYYY-MM-DD}.md`

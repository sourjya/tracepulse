...
That's it. TracePulse auto-detects your project type and provides 45 tools immediately. No server command needed - the agent calls `start_server()` when ready.

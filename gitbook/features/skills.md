...
|-------|------|----------------|
| **TracePulse** | [`skills/tracepulse/SKILL.md`](https://github.com/sourjya/tracepulse/blob/main/skills/tracepulse/SKILL.md) | All 42 tools, when to use each, query mappings, pro tips |
